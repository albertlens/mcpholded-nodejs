...
class HoldedService {
    ...
    async createAppointment(appointmentData) {
        try {
            ...
            const response = await this.axiosInstance.post(holdedConfig.endpoints.calendar, appointmentData);
            return response.data;
        }
        catch (error) {
    ...
    async getAppointmentById(appointmentId) {
        try {
            const response = await this.axiosInstance.get(`${holdedConfig.endpoints.calendar}/${appointmentId}`);
            return response.data;
        }
        catch (error) {
    ...
    async updateAppointment(appointmentId, updateData) {
        try {
            const response = await this.axiosInstance.put(`${holdedConfig.endpoints.calendar}/${appointmentId}`, updateData);
            return response.data;
        }
        catch (error) {
    ...
    async deleteAppointment(appointmentId) {
        try {
            const response = await this.axiosInstance.delete(`${holdedConfig.endpoints.calendar}/${appointmentId}`);
            return response.data;
        }
        catch (error) {
